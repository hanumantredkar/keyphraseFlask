...
@app.route('/extractedKeyphrases')
def extractedKeyphrases():
    print ("Hello")
    # str = 'Hello Brothers and sisters'
    # str = ''
    dictExtractedKeyAndLocations = {}
    dictExtractedKeyAndLocations = getpython()
    # for key, value in dictExtractedKeyAndLocations.items():
...
def getpython():
  ...
  # str = dictFinalKeyphrasesLocation[1]
